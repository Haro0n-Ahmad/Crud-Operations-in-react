...
<div className='parent'>
    ...
    return <div key={idx}>
		<Card company={elem. nameOfCompany} post={elem.post} brandLogo={elem.brandLogo} tag1={elem.tag1} tag2={elem.tag2}
	pay={elem.pay} location={elem.location} datePosted={elem.datePosted} 
	/>
	</div>
})}
